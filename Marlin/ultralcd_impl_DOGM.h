...
// LCD selection
  ...
  // Generic support for SSD1309 OLED   LCDs
  #if ENABLED(U8GLIB_SSD1309_SPI_HW)
    U8GLIB_SSD1309_128X64 u8g(DOGLCD_CS, DOGLCD_A0);
  #elif ENABLED(U8GLIB_SSD1309_SPI_SW)
    U8GLIB_SSD1309_128X64 u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0);
  #else
