...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Replicator 1 Evo (using TEMP_SENSOR_BED 8)
  #define DEFAULT_bedKp 80.34
  #define DEFAULT_bedKi 14.04
  #define DEFAULT_bedKd 306.37
...
#define DYI_SPI_SSD1309
  ...
  #define LCD_RESET_PIN LCD_PINS_RS // This controller need a reset pin
